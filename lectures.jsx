...
// // ViewLectures.jsx (modified to integrate directly in Student.jsx)
...
//         setLectures([]); // clear on error
//         return;
//       }

//       const data = await response.json();

//       console.log("Backend lectures data:", data);  // Add this line

//       // Assuming API returns { lectures: [ { lecture_title, lecture_url }, ... ] }
//       // Map backend response to front-end format used for rendering:
//       const fetchedLectures = data.lectures.map((lec) => ({
//         id:  lec.id || lec.lecture_id || lec.lectureId || lec._id, // or lec.id if available
//         courseId: courseId,
//         title: lec.lecture_title,
//         type: lec.lecture_url.endsWith(".pdf") ? "pdf" : "video", // simple type guess
//         file: lec.lecture_url,
//         lecture_id:  lec.id || lec.lecture_id || lec.lectureId || lec.id,
//         date: "", // optional: add date if your backend returns it
//       }));
...
//   const findVideo = async (courseId, lecture_id) => {
//   try {
//     const token = localStorage.getItem("authToken");
//     if (!token) {
...
//     const response = await fetch(
//       `http://localhost:5000/find_video/find_video?course_id=${courseId}&lecture_id=${lecture_id}`, 
//       {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         }
...
//     // { video_url: "...", is_youtube: true|false, embed_url: "..." }
    
//     setVideoData({
//       video_url: data.video_url,
//       video_title: data.video_title || "Video",
//       is_youtube: data.is_youtube,
//       embed_url: data.embed_url || data.video_url, // fallback if embed_url missing
//     });
...
// //       return;
// //     }
// //     console.log("lecture id " , lecture.lecture_id , "course id : ", courseId)
// //     const response = await fetch(
// //       `http://localhost:5000/find_video/find_video?course_id=${lecture.courseId}&lecture_id=${lecture.lecture_id}`,
// //       {
// //         method: "GET",
// //         headers: {
// //           Authorization: `Bearer ${token}`,
...
// //       alert(errData.error || "Failed to fetch video.");
// //       return;
// //     }

// //     const data = await response.json();

// //     // Save full video data for modal use
// //     setVideoData({
// //       video_url: data.video_url,
// //       video_title: data.video_title || "Video",
...
//   const handleViewVideo = async (lecture) => {
//     try {
//     console.log("Full lecture object available:", lecture);
//     console.log("Available keys:", Object.keys(lecture));
...
//     // Get ID - trying all possible field names
//     const lectureId = lecture.lecture_id || lecture.id || lecture.lectureId || lecture._id;
    
//     if (!lectureId) {
//       console.error("Available lecture object:", lecture);
...
//     const paginated = filtered; // show all without slicing

//     const totalPages = 1; // only 1 page, no pagination needed
...
//       {/* Lecture card clickable to open lecture file */}
//           <a
//             href={lecture.file}
//             target="_blank"
...
//             Date: {lecture.date || "N/A"} • Type: {lecture.type.toUpperCase()}
//             </p>
//           </a>

//       {/* View Video button triggers modal */}
//           <button
//             onClick={() => handleViewVideo(lecture)}
//             className="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition"
//           >
